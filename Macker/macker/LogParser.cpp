/* macker/LogParser.cpp */
/* Parse log file generated by Permod. */
...
void LogParser::parse(const std::string &TargetFile) {
  ...
  while (std::getline(Stream, Line)) {
    ...
    std::string FileName, LineNumber, FunctionName, EventType, ConditionID,
        Content, ExtraInfo;
    ...
    unsigned CondID = std::stoi(ConditionID);

    ParsedLogs.push_back({FileName,
                          LineNum,
                          FunctionName,
                          EventType,
                          CondID,
...
const std::vector<permod::LogManager::LogEntry> &
